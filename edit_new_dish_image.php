...
<?php
$images = new Images();
$categories_image = new CategoriesImage();

$allCategories = $categories_image->all();
...
<a class="btn btn-info mt-5 btn btn-info" href="index.php#nova_jela">Vrati se nazad</a>
            ...
            <form role="form" action="ImageController.php?id_image=<?php echo $id_image; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <b><label for="descritpion">Opis slike</label></b>
                        <input placeholder="Ako je potrebno" type="text" name="description" class="form-control" value="<?php if(!empty($id_image)) echo $image->description; ?>">
                    </div>
                ...
                <div class="card-footer">
                    <button type="submit" name="izmeni_nova_jela_sliku" class="btn btn-primary">Izmeni</button>
                </div>
